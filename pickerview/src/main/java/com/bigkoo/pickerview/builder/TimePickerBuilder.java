...
public class TimePickerBuilder {
     ...
     * @return
     */
    public TimePickerBuilder setMinuteLabel(List<String> minuteLabel){
        mPickerOptions.minuteData = minuteLabel;
        mPickerOptions.isCustomHMS = true;
        return this;
    }
    /**
     * 对小时的数据设置
     ...
     * @return
     */
    public TimePickerBuilder setHourLabel(List<String> hourLabel){
        mPickerOptions.hourData = hourLabel;
        mPickerOptions.isCustomHMS = true;
        return this;
    }
     ...
     * @return
     */
    public TimePickerBuilder setSecondLabel(List<String> secondLabel){
        mPickerOptions.secondData = secondLabel;
        mPickerOptions.isCustomHMS = true;
        return this;
    }


    public TimePickerBuilder set12Hour(boolean is12Hour){
        mPickerOptions.is12Hours = is12Hour;
        return this;
    }

    public TimePickerBuilder setLabelYear(String year){
        mPickerOptions.label_year = year;
        return this;
    }
    public TimePickerBuilder setLabelMonth(String month){
        mPickerOptions.label_year = month;
        return this;
    }

    public TimePickerBuilder setLabelDay(String day){
        mPickerOptions.label_day = day;
        return this;
    }

    public TimePickerBuilder setLabelHour(String hour){
        mPickerOptions.label_hours = hour;
        return this;
    }

    public TimePickerBuilder setLabelMinute(String minute){
        mPickerOptions.label_minutes = minute;
        return this;
    }

    public TimePickerBuilder setLabelSecond(String second){
        mPickerOptions.label_seconds = second;
        return this;
    }
